...
const rutas = [
  ...
  { path: '/contacto', name: 'contacto', component: () => import('../vistas/ContactoVista.vue'), meta: { titulo: 'Contacto', ocultaAdministrador: true } },
...
enrutador.beforeEach((ruta) => {
  ...
  if (ruta.meta.ocultaAdministrador && !sesion.puedeVerContacto) {
    return { name: 'administracion' }
  }
