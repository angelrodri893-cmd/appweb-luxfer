...
<template>
  ...
  <section v-else-if="servicio" class="detalle-servicio">
    ...
    <div class="detalle-servicio__contenido">
      ...
      <div class="grupo-acciones"><RouterLink class="control control--principal" :to="{ name: 'agendar', query: { servicio: servicio.slug } }">Solicitar este servicio</RouterLink><RouterLink class="enlace-simple" to="/servicios">Volver a servicios</RouterLink></div>
    </div>
  </section>
